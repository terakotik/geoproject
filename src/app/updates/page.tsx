...
export default function UpdatesPage() {
  const updates = [
    {
      date: '1 октября 2023',
      title: 'Новые федеральные правила по определению водно-болотных угодий',
      content: 'Правительство выпустило новые рекомендации по определению водно-болотных угодий, что влияет на проекты застройки вблизи охраняемых водоемов. Эти изменения требуют обновленных методов съемки и стандартов отчетности. Наша команда полностью обучена этим новым требованиям.'
    },
    {
      date: '15 сентября 2023',
      title: 'Изменения на государственном уровне стандартов кадастрового картографирования',
      content: 'Штат принял новый цифровой стандарт для всех кадастровых карт, подаваемых после 1 января 2024 года. Все новые съемки должны соответствовать формату данных Geo-XYZ. Мы обновили наше программное обеспечение и процессы для обеспечения полного соответствия.'
    },
    {
      date: '28 августа 2023',
      title: 'Введение новой категории ЗОУИТ: Городские зеленые зоны',
      content: 'Несколько муниципалитетов ввели новую категорию ЗОУИТ для "Городских зеленых зон". В этих зонах действуют строгие ограничения на новое строительство и изменение земель. Используйте наш инструмент идентификации ЗОУИТ, чтобы проверить, затронута ли ваша собственность.'
    },
    {
      date: '5 июля 2023',
      title: 'Обновленные правила использования дронов для аэрофотосъемки',
      content: 'Авиационное управление выпустило обновленные правила для коммерческих операций с дронами, включая новые ограничения по высоте полета и требования к конфиденциальности данных для аэрофотосъемок. GeoExpert полностью лицензирован и соответствует всем новым правилам.'
    }
  ];
           ...
           <div className="text-center mt-12">
                <Card className="inline-block p-8 bg-accent text-accent-foreground max-w-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                       ...
                       <Button variant="secondary">+7 (952) 276-49-40</Button>
                    </div>
                </Card>
            </div>
        </div>
